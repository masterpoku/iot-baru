        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <div class="misc-wrapper"><a class="brand-logo" href="javascript:void(0);">
                        ...
                        <h2 class="brand-text text-primary ml-1">Smart IoT</h2>
                    </a>
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            <h2 class="mb-1">403 <br> {{$exception->getMessage() ?: 'Forbidden'}} 🕵🏻‍♀️</h2>
                            <p class="mb-2">Oops! 😖 403 {{$exception->getMessage() ?: 'Forbidden'}}.</p><a class="btn btn-primary mb-2 btn-sm-block" href="{{route('dashboard')}}">Back to home</a><img class="img-fluid" src="{{ asset('template') }}/app-assets/images/pages/error.svg" alt="Error page" />
                        </div>
                    </div>
                </div>
            </div>
